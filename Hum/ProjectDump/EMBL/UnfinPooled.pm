...
### Hum::ProjectDump::EMBL::UnfinPooled

package Hum::ProjectDump::EMBL::UnfinPooled;
...
use vars qw{ @ISA };
@ISA = qw{ Hum::ProjectDump::EMBL::Unfinished };
...
=head1 NAME - Hum::ProjectDump::EMBL::UnfinPooled
